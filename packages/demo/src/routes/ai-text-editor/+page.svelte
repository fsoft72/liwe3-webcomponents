<script lang="ts">
	...
	let currentWordCount = $state<number>(0);
	...
	// Update current word count when it changes
	$effect(() => {
	...
	const loadSampleText = () => {
		const sampleText = `Welcome to the AI Text Editor demo!

This component provides AI-powered text continuation suggestions. As you type, it will suggest how to continue your text.

To use the AI features:
1. Set your OpenAI API key in the settings
2. Start typing
3. Wait for suggestions to appear (gray text)
4. Press Tab to accept suggestions paragraph by paragraph
5. Press Escape to dismiss suggestions

Try it out by continuing this text...`;
...
<div class="page-container">
	<h1>AITextEditor Component Demo</h1>
	<p class="subtitle">Text editor with AI-powered continuation suggestions</p>

	<!-- API Key Settings -->
	<section class="demo-section">
		<div class="settings-header">
			<h2>Settings</h2>
			<button class="toggle-btn" on:click={() => showApiKeySettings = !showApiKeySettings}>
			...
			<div class="settings-box">
				...
				<div class="setting-item">
					...
					<input
						...
						step="0.5"
						class="delay-input"
						on:change={() => editorInstance?.setSuggestionDelay(suggestionDelay)}
					/>
					<small class="hint">
		...
		<div class="status-bar">
			...
			<span class="status-item">
				Word Count: <strong>{currentWordCount}</strong>
			</span>
		</div>
	</section>
	...
	<section class="demo-section">
		<div class="editor-header">
			<h2>Editor</h2>
			<button class="load-sample-btn" on:click={loadSampleText}>
				Load Sample Text
			</button>
		</div>
		...
		<div class="instructions">
			...
			<ul>
				...
				<li><strong>Type naturally</strong> - Suggestions appear after you pause typing</li>
			</ul>
		</div>
	</section>
