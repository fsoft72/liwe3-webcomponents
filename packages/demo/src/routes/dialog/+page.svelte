...
<div class="demo-container">
	...
	<section class="demo-section">
		<h2>Overview</h2>
		<p>
			The Dialog component provides a powerful way to show modal dialogs to users. It supports HTML content, custom buttons, modal backdrop with blur effect, keyboard
	...
	<section class="demo-section">
		<h2>Usage Example</h2>
		<p>
			First, add the <code>&lt;Dialogs /&gt;</code> component to your layout to initialize the dialog system:
		</p>
